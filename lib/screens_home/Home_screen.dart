              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    CircleAvatar(
                      radius: 30,
                      backgroundImage: AssetImage('assets/musa1.png'),
                    ),
                    SizedBox(height: 10),
                    Text("Dev Musa Alom Mim",
                        style: TextStyle(color: Colors.white, fontSize: 18)),
                    Text("mdmim018islam@gmail.com",
              ...
              Card(
                ...
                child: GridView.builder(
                  ...
                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                    crossAxisCount: screenWidth > 600 ? 4 : 3, // Dynamic grid
                    mainAxisSpacing: 8.0,
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return InkWell(
                      onTap: () {
                        // Use the index to determine which category was tapped and navigate accordingly
                        switch (index) {
                          case 0:
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => const ProbidhansScreen()),
                            );
                            break;
                          case 1:
                            Navigator.push(
...
class _SlidingTextCardState extends State<SlidingTextCard> {
  final List<String> texts = [
    'ডিপ্লোমা-ইঞ্জিনিয়ারিং শিক্ষাক্রম (ডিসেম্বর, ২০২৪-জানুয়ারি, ২০২৫ মাসে)',
